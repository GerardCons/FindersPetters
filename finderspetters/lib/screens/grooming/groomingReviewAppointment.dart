...
class groomingReviewAppointment extends StatefulWidget {
  ...
  const groomingReviewAppointment(
      {Key? key,
  ...
  @override
  _groomingReviewAppointmentState createState() =>
      _groomingReviewAppointmentState();
}

class _groomingReviewAppointmentState extends State<groomingReviewAppointment> {
  ...
  InkWell loginButton(Size size) {
    return InkWell(
      onTap: (() {
        ...
        Timestamp appointmentDateTimestamp =
            Timestamp.fromDate(widget.selectedDate);
        final _uid = uuid.v4();
        uid = _uid;
        final bookData =
            FirebaseFirestore.instance.collection('User Bookings').doc(uid);

        final data = {
          'id': uid,
          'hasOrdered': false,
          'orderedDate': null,
          'storeId': widget.clinicId,
          'storeName': widget.clinicName,
          'storeAddress': widget.clinicAddress,
          'userEmail': user.email,
          'bookingDate': timestamp,
          'appointmentDate': appointmentDateTimestamp,
          'petKind': widget.petkind,
          'time': formattedTime,
        ...
        Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => SuccessAppointmentPage()));
      }),
